...
export const siteConfig: SiteConfig = {
  ...
  revive: {
    ...
    zones: {
      mobileSticky: { zoneId: 650, format: "mobileBanner" },
      inContent: { zoneId: 649, format: "mediumRectangle" },
      header: { zoneId: 648, format: "leaderboard" },
      halfPage: { zoneId: 646, format: "halfPage" },
      largeRectangle: { zoneId: 647, format: "largeRectangle" },
      skyscraper: { zoneId: 651, format: "skyscraper" },
    },
  },
